...
public class ToggleListTests {
    private WebDriver driver;
    private MainPage mainPage;

    @Parameterized.Parameters
    public static Object[][] questionsArray () {
        return new Object[][] {
    ...
    public ToggleListTests(int questionIndex, String expectedAnswer) {
    ...
    public void answersTest() {
        mainPage.clickOnArrow(questionIndex);
